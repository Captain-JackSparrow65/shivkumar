...
const FaacFc = require('../../models/FaacFc');
...
router.post(
  ...
  async (req, res, next) => {
    ...
    const hostel = new FaacFc({
      ...
      adharCard: req.files['avatar1'][0].path,
      photo: req.files['avatar2'][0].path,
      puc: req.files['avatar3'][0].path,
      UG: req.files['avatar4'][0].path,
      PG: req.files['avatar5'][0].path,
      collegeID: req.files['avatar6'][0].path,
      bankDetails: req.files['avatar7'][0].path,
      incomeCertificate: req.files['avatar8'][0].path,
      casteCertificate: req.files['avatar9'][0].path,
    });
    await hostel
      .save()
      .then((result) => {
